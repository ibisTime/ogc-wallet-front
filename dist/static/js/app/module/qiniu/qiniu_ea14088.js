...
define('js/app/module/qiniu/qiniu', ['js/app/util/ajax'], function (Ajax) {
            ...
            var uploader = Qiniu.uploader({
                ...
                init: {
                    ...
                    'BeforeUpload': function BeforeUpload(up, file) {
                        ...
                        if (file.type == 'image/jpg' || file.type == 'image/jpeg' || file.type == 'image/gif' || file.type == 'image/png' || file.type == 'image/bmp') {} else {
                            uploader.stop();
