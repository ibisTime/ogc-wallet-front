...
define('js/app/module/weixin/index', ['js/lib/jweixin-1.2.0', 'js/app/module/loading/index', 'js/app/interface/GeneralCtr'], function (wx, loading, GeneralCtr) {
    var globalConfig = {};
    /*
     * 初始化微信分享
    ...
    return {
         ...
         * }
         */
        initShare: function initShare(config) {
            GeneralCtr.getInitWXSDKConfig().then(function (data) {
         ...
         */
        initPay: function initPay(wxConfig, success, error) {
         ...
         * success: func, error: func
         */
        initScanQRCode: function initScanQRCode(success, error) {
            GeneralCtr.getInitWXSDKConfig().then(function (data) {
