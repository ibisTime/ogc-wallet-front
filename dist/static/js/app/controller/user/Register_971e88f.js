...
define('js/app/controller/user/Register', ['js/app/controller/base', 'js/app/interface/UserCtr', 'js/app/module/validate/index', 'js/app/module/smsCaptchaNC/index', 'js/app/interface/GeneralCtr'], function (base, UserCtr, Validate, smsCaptcha, GeneralCtr) {
  ...
  function getListCountry() {
    return UserCtr.getListCountry().then(function (data) {
      base.hideLoading();
      var countryPic = '';
      var html = '';
      var firstCode = '';
  ...
  function register(params, type) {
    ...
    if (type === 'mobile') {
      ...
      UserCtr.mobileRegister(params).then(function (data) {
        if (data) {
          doRegister(data);
        }
      }, function () {
    ...
    if (type === 'email') {
      ...
      UserCtr.emailRegister(params).then(function (data) {
        if (data) {
          doRegister(data);
        }
      }, function () {
  ...
  function addListener() {
    ...
    // 判断密码安全级别
    var aqpaw = /[A-Za-z].*[0-9]|[0-9].*[A-Za-z]/;
    var dxpaw = /[A-Z]/;
    var xxpaw = /[a-z]/;
